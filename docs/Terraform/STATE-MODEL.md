...
> **Status of this document.** Sections marked **[planned]** describe behaviour shipped under the IS step `S-006a/b/c` work, gated behind the `Terraform:UseConsolidatedLifecycle` feature flag. See `docs/terraform-hardening/IS-terraform-hardening.md` for the implementation sequence.
