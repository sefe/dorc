        ...
        public ScriptGroup GetScriptGroupProperties(string scriptGroupPipeName)
        {
            ...
            try
            {
                    ...
                    PipeDirection.In))
                {
                    ...
                    // The payload names its own sensitive properties; merge
                    // them into the redaction options so explicitly flagged
                    // parameters are redacted even when their names defeat
