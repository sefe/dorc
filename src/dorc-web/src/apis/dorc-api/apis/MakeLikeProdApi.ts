...
import type { MakeLikeProdRequest } from '../models';
...
export class MakeLikeProdApi extends BaseAPI {
  /**
   */
  makeLikeProdDataBackupsGet({
    projectId
  }: MakeLikeProdDataBackupsGetRequest): Observable<Array<string>>;
  makeLikeProdDataBackupsGet(
    { projectId }: MakeLikeProdDataBackupsGetRequest,
    opts?: OperationOpts
  ...
  makeLikeProdNotifyEmailAddressGet(
    opts?: OperationOpts
  ...
  makeLikeProdPut({
    makeLikeProdRequest
  }: MakeLikeProdPutRequest): Observable<void>;
  makeLikeProdPut(
    { makeLikeProdRequest }: MakeLikeProdPutRequest,
    opts?: OperationOpts
