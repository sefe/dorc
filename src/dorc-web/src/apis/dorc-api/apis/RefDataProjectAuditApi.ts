...
export class RefDataProjectAuditApi extends BaseAPI {
  ...
  refDataProjectAuditPut({
    ...
    limit,
    pagedDataOperators
  }: RefDataProjectAuditPutRequest): Observable<GetRefDataAuditListResponseDto>;
  refDataProjectAuditPut(
    {
      projectId,
      page,
      limit,
      pagedDataOperators
    }: RefDataProjectAuditPutRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<GetRefDataAuditListResponseDto>>;
  refDataProjectAuditPut(
    {
      projectId,
      page,
    ...
    | GetRefDataAuditListResponseDto
    | AjaxResponse<GetRefDataAuditListResponseDto>
  > {
