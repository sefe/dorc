...
import type { PropertyApiModel, Response } from '../models';
...
export class PropertiesApi extends BaseAPI {
  ...
  apiPropertiesDelete({
    requestBody
  }: ApiPropertiesDeleteRequest): Observable<Array<Response>>;
  apiPropertiesDelete(
    { requestBody }: ApiPropertiesDeleteRequest,
    opts?: OperationOpts
  ...
  apiPropertiesGet(
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<PropertyApiModel>>>;
  apiPropertiesGet(
    opts?: OperationOpts
  ): Observable<
    Array<PropertyApiModel> | AjaxResponse<Array<PropertyApiModel>>
  > {
  ...
  /**
   */
  apiPropertiesIdidGet({
    id
  }: ApiPropertiesIdidGetRequest): Observable<PropertyApiModel>;
  apiPropertiesIdidGet(
    { id }: ApiPropertiesIdidGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<PropertyApiModel>>;
  apiPropertiesIdidGet(
    { id }: ApiPropertiesIdidGetRequest,
    opts?: OperationOpts
  ): Observable<PropertyApiModel | AjaxResponse<PropertyApiModel>> {
  ...
  apiPropertiesPost({
    propertyApiModel
  }: ApiPropertiesPostRequest): Observable<Array<Response>>;
  apiPropertiesPost(
    { propertyApiModel }: ApiPropertiesPostRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Response>>>;
  apiPropertiesPost(
    { propertyApiModel }: ApiPropertiesPostRequest,
  ...
  apiPropertiesPut({
    requestBody
  }: ApiPropertiesPutRequest): Observable<Array<Response>>;
  apiPropertiesPut(
    { requestBody }: ApiPropertiesPutRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Response>>>;
  apiPropertiesPut(
    { requestBody }: ApiPropertiesPutRequest,
  ...
  propertiesDelete({
    requestBody
  }: PropertiesDeleteRequest): Observable<Array<Response>>;
  propertiesDelete(
    { requestBody }: PropertiesDeleteRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Response>>>;
  propertiesDelete(
    { requestBody }: PropertiesDeleteRequest,
  ...
  propertiesIdidGet({
    id
  }: PropertiesIdidGetRequest): Observable<PropertyApiModel>;
  propertiesIdidGet(
    { id }: PropertiesIdidGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<PropertyApiModel>>;
  propertiesIdidGet(
    { id }: PropertiesIdidGetRequest,
  ...
  propertiesPost({
    propertyApiModel
  }: PropertiesPostRequest): Observable<Array<Response>>;
  propertiesPost(
    { propertyApiModel }: PropertiesPostRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Response>>>;
  propertiesPost(
    { propertyApiModel }: PropertiesPostRequest,
  ...
  propertiesPut({
    requestBody
  }: PropertiesPutRequest): Observable<Array<Response>>;
  propertiesPut(
    { requestBody }: PropertiesPutRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Response>>>;
  propertiesPut(
    { requestBody }: PropertiesPutRequest,
