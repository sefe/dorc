...
export class RefDataEnvironmentsUsersApi extends BaseAPI {
  /**
   */
  refDataEnvironmentsUsersGet({
    id,
    type
  }: RefDataEnvironmentsUsersGetRequest): Observable<Array<UserApiModel>>;
  refDataEnvironmentsUsersGet(
    { id, type }: RefDataEnvironmentsUsersGetRequest,
    opts?: OperationOpts
  ...
  /**
   */
  refDataEnvironmentsUsersIdGet({
    id
  }: RefDataEnvironmentsUsersIdGetRequest): Observable<Array<UserApiModel>>;
  refDataEnvironmentsUsersIdGet(
    { id }: RefDataEnvironmentsUsersIdGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<UserApiModel>>>;
  refDataEnvironmentsUsersIdGet(
    { id }: RefDataEnvironmentsUsersIdGetRequest,
  ...
  /**
   */
  refDataEnvironmentsUsersOwnerIdGet({
    id
  }: RefDataEnvironmentsUsersOwnerIdGetRequest): Observable<EnvironmentOwnerApiModel>;
  refDataEnvironmentsUsersOwnerIdGet(
    { id }: RefDataEnvironmentsUsersOwnerIdGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<EnvironmentOwnerApiModel>>;
  refDataEnvironmentsUsersOwnerIdGet(
    { id }: RefDataEnvironmentsUsersOwnerIdGetRequest,
    opts?: OperationOpts
  ): Observable<
    EnvironmentOwnerApiModel | AjaxResponse<EnvironmentOwnerApiModel>
  > {
    throwIfNullOrUndefined(id, 'id', 'refDataEnvironmentsUsersOwnerIdGet');

    return this.request<EnvironmentOwnerApiModel>(
      {
        url: '/RefDataEnvironmentsUsers/owner/{id}'.replace(
          '{id}',
          encodeURI(id)
        ),
        method: 'GET'
  ...
  refDataEnvironmentsUsersOwnerIdPut({
    id,
    environmentOwnerApiModel
  }: RefDataEnvironmentsUsersOwnerIdPutRequest): Observable<boolean>;
  refDataEnvironmentsUsersOwnerIdPut(
    { id, environmentOwnerApiModel }: RefDataEnvironmentsUsersOwnerIdPutRequest,
    opts?: OperationOpts
  ...
  refDataEnvironmentsUsersSearchUsersSearchGet({
    search
  }: RefDataEnvironmentsUsersSearchUsersSearchGetRequest): Observable<
    Array<UserElementApiModel>
  >;
  refDataEnvironmentsUsersSearchUsersSearchGet(
    { search }: RefDataEnvironmentsUsersSearchUsersSearchGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<UserElementApiModel>>>;
  refDataEnvironmentsUsersSearchUsersSearchGet(
    { search }: RefDataEnvironmentsUsersSearchUsersSearchGetRequest,
    opts?: OperationOpts
  ): Observable<
    Array<UserElementApiModel> | AjaxResponse<Array<UserElementApiModel>>
  > {
    ...
    return this.request<Array<UserElementApiModel>>(
      {
        url: '/RefDataEnvironmentsUsers/SearchUsers/{search}'.replace(
          '{search}',
          encodeURI(search)
        ),
        method: 'GET'
