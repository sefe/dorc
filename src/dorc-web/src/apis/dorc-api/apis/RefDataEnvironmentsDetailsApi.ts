...
export class RefDataEnvironmentsDetailsApi extends BaseAPI {
  /**
   */
  refDataEnvironmentsDetailsGet({
    id,
    type
  }: RefDataEnvironmentsDetailsGetRequest): Observable<DatabaseApiModelEnvironmentComponentsDto>;
  refDataEnvironmentsDetailsGet(
    { id, type }: RefDataEnvironmentsDetailsGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<DatabaseApiModelEnvironmentComponentsDto>>;
  refDataEnvironmentsDetailsGet(
    { id, type }: RefDataEnvironmentsDetailsGetRequest,
    opts?: OperationOpts
  ): Observable<
    | DatabaseApiModelEnvironmentComponentsDto
    | AjaxResponse<DatabaseApiModelEnvironmentComponentsDto>
  > {
  ...
  refDataEnvironmentsDetailsGetComponentStatuesGet({
    envName,
    cutoffDateTime
  }: RefDataEnvironmentsDetailsGetComponentStatuesGetRequest): Observable<
    Array<EnvironmentContentBuildsApiModel>
  >;
  refDataEnvironmentsDetailsGetComponentStatuesGet(
    {
      envName,
      cutoffDateTime
    }: RefDataEnvironmentsDetailsGetComponentStatuesGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<EnvironmentContentBuildsApiModel>>>;
  refDataEnvironmentsDetailsGetComponentStatuesGet(
    {
      envName,
      cutoffDateTime
    ...
    | Array<EnvironmentContentBuildsApiModel>
    | AjaxResponse<Array<EnvironmentContentBuildsApiModel>>
  > {
    const query: HttpQuery = {};
    ...
    if (cutoffDateTime != null) {
      query['cutoffDateTime'] = cutoffDateTime;
    }
  ...
  /**
   */
  refDataEnvironmentsDetailsGetEnvironmentsForDatabaseGet({
    serverName,
    databaseName
  }: RefDataEnvironmentsDetailsGetEnvironmentsForDatabaseGetRequest): Observable<
  ...
  refDataEnvironmentsDetailsGetEnvironmentsForDatabaseGet(
    {
      serverName,
      databaseName
    }: RefDataEnvironmentsDetailsGetEnvironmentsForDatabaseGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<EnvironmentApiModel>>>;
  refDataEnvironmentsDetailsGetEnvironmentsForDatabaseGet(
    {
      serverName,
      databaseName
    ...
    Array<EnvironmentApiModel> | AjaxResponse<Array<EnvironmentApiModel>>
  > {
    const query: HttpQuery = {};
  ...
  refDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGet({
    id
  }: RefDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGetRequest): Observable<
    Array<EnvironmentApiModel>
  >;
  refDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGet(
    { id }: RefDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<EnvironmentApiModel>>>;
  refDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGet(
    { id }: RefDataEnvironmentsDetailsGetPossibleEnvironmentChildrenGetRequest,
  ...
  refDataEnvironmentsDetailsIdGet({
    id
  }: RefDataEnvironmentsDetailsIdGetRequest): Observable<EnvironmentContentApiModel>;
  refDataEnvironmentsDetailsIdGet(
    { id }: RefDataEnvironmentsDetailsIdGetRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<EnvironmentContentApiModel>>;
  refDataEnvironmentsDetailsIdGet(
    { id }: RefDataEnvironmentsDetailsIdGetRequest,
    opts?: OperationOpts
  ): Observable<
    EnvironmentContentApiModel | AjaxResponse<EnvironmentContentApiModel>
  > {
  ...
  refDataEnvironmentsDetailsPut({
    ...
    action,
    component
  }: RefDataEnvironmentsDetailsPutRequest): Observable<ApiBoolResult>;
  refDataEnvironmentsDetailsPut(
    {
      envId,
      componentId,
      action,
      component
    }: RefDataEnvironmentsDetailsPutRequest,
    opts?: OperationOpts
  ...
  refDataEnvironmentsDetailsSetParentForEnvironmentPut({
    parentEnvId,
    childEnvId
  }: RefDataEnvironmentsDetailsSetParentForEnvironmentPutRequest): Observable<ApiBoolResult>;
  refDataEnvironmentsDetailsSetParentForEnvironmentPut(
    {
      parentEnvId,
      childEnvId
    }: RefDataEnvironmentsDetailsSetParentForEnvironmentPutRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<ApiBoolResult>>;
  refDataEnvironmentsDetailsSetParentForEnvironmentPut(
    {
    ...
    if (parentEnvId != null) {
      query['parentEnvId'] = parentEnvId;
    }
    if (childEnvId != null) {
      query['childEnvId'] = childEnvId;
    }
