...
import type { ConfigValueApiModel } from '../models';
...
export class RefDataConfigApi extends BaseAPI {
  ...
  refDataConfigGet(
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<ConfigValueApiModel>>>;
  refDataConfigGet(
    opts?: OperationOpts
  ): Observable<
    Array<ConfigValueApiModel> | AjaxResponse<Array<ConfigValueApiModel>>
  > {
  ...
  refDataConfigPost({
    configValueApiModel
  }: RefDataConfigPostRequest): Observable<ConfigValueApiModel>;
  refDataConfigPost(
    { configValueApiModel }: RefDataConfigPostRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<ConfigValueApiModel>>;
  refDataConfigPost(
    { configValueApiModel }: RefDataConfigPostRequest,
    opts?: OperationOpts
  ): Observable<ConfigValueApiModel | AjaxResponse<ConfigValueApiModel>> {
  ...
  refDataConfigPut({
    id,
    configValueApiModel
  }: RefDataConfigPutRequest): Observable<ConfigValueApiModel>;
  refDataConfigPut(
    { id, configValueApiModel }: RefDataConfigPutRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<ConfigValueApiModel>>;
  refDataConfigPut(
    { id, configValueApiModel }: RefDataConfigPutRequest,
