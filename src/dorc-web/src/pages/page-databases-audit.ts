...
export class PageDatabasesAudit extends PageElement {
  ...
  protected firstUpdated(_changedProperties: PropertyValues) {
    ...
    this.addEventListener(
      'database-audit-loaded',
      this.auditLoaded as EventListener
    );
    this.addEventListener(
      'searching-database-audit-started',
      this.searchingStarted as EventListener
    );
    this.addEventListener(
      'searching-database-audit-finished',
  ...
  private databaseNameRenderer = (item: DatabaseAuditApiModel) => {
  ...
  private dateRenderer = (item: DatabaseAuditApiModel) => {
    const raw = item?.Date;
  ...
  private valueRenderer(fieldName: 'FromValue' | 'ToValue') {
    return (item: DatabaseAuditApiModel) => {
