...
public class AuthNegotiateHandler : AuthenticationHandler<AuthNegotiateOptions>, IAuthenticationRequestHandler
{
    ...
    public async Task<bool> HandleRequestAsync()
    {
        ...
        try
        {
            using (var profiler = new TimeProfiler(this.Logger, "NegotiateHandler.HandleRequestAsync"))
            {
                ...
                profiler.LogTime("GetConnectionItems");
                ...
                profiler.LogTime("possible Reauthenticating");
                ...
                profiler.LogTime("GetOutgoingBlob");
                ...
                if (!_negotiateState.IsCompleted)
                {
                    ...
                    profiler.LogTime("EstablishConnectionPersistence");
                ...
                if (_negotiateState.Protocol == "NTLM" && !Options.PersistNtlmCredentials)
                {
                    ...
                    profiler.LogTime("NTLM DisablingCredentialPersistence + RegisterForDispose");
                }
                else if (_negotiateState.Protocol == "Kerberos")
                {
                    ...
                    profiler.LogTime("Kerberos CredentialPersistence + RegisterForDispose");
                }
            }
        ...
        catch (Exception ex)
        {
            ...
            using (var profiler = new TimeProfiler(this.Logger, "NegotiateHandler.HandleRequestAsync.ExceptionHandling"))
            {
    ...
    {
        using (var profiler = new TimeProfiler(this.Logger, "NegotiateHandler.HandleAuthenticateAsync"))
        {
            ...
            profiler.LogTime("get auth context");
            await Events.Authenticated(authenticatedContext);
            profiler.LogTime("Events.Authenticated");
    ...
    {
        using (var profiler = new TimeProfiler(this.Logger, "NegotiateHandler.HandleChallengeAsync"))
        {
