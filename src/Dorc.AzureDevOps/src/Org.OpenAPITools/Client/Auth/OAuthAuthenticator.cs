...
namespace Org.OpenAPITools.Client.Auth
{
    ...
    public class OAuthAuthenticator : AuthenticatorBase
    {
        ...
        {
            RestClient client = new RestClient(_tokenUrl,
                configureSerialization: (sirializerConfig) => sirializerConfig.UseSerializer(() => new CustomJsonCodec(_serializerSettings, _configuration)));
