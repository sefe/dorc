...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BuildsDeletedEvent : IValidatableObject
    {
        /// <summary>
        ...
        public BuildsDeletedEvent(List<int> buildIds = default, int definitionId = default, Guid projectId = default)
        {
