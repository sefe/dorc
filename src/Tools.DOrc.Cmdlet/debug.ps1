...
#     Set-Location "c:\Tests\Tools.DOrc.Cmdlet"
#     Import-Module .\DOrc.Cmdlet.psm1
#     Add-EndurUser -account pmarchanka -url http://dorcappurl/referencedataapi/api } -Session $s

#Add-NonProdEndurUser -account pm -Apiurl http://dorcappurl/referencedataapi/api 